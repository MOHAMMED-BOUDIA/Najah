      ...
      <div className="min-h-screen bg-white dark:bg-gray-950 text-gray-900 dark:text-white">
        ...
        <section className="pt-32 pb-20">
          <div className="max-w-3xl mx-auto px-6 text-center">
            ...
            <Link to="/blog" className="text-indigo-600 dark:text-indigo-400 hover:underline">Back to blog</Link>
          </div>
        </section>
        <Footer />
      </div>
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 text-gray-900 dark:text-white overflow-x-hidden">
      ...
      <section className="pt-32 pb-20">
        <div className="max-w-3xl mx-auto px-6">
          <Link to="/blog" className="inline-flex items-center gap-2 text-sm text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors mb-8">
